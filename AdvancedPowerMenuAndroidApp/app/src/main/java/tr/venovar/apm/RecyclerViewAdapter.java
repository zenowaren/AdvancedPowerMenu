                ...
                new MaterialAlertDialogBuilder(_context, R.style.CustomMaterialAlertDialog)
                        ...
                        .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                sendCommand(_taskList.get(viewHolder.getAdapterPosition()).getClientIP(), _taskList.get(viewHolder.getAdapterPosition()).getClientPort(), "GET /?action_is=Shutdown HTTP/1.1");
            ...
            public void onClick(View view) {
                new MaterialAlertDialogBuilder(_context, R.style.CustomMaterialAlertDialog)
                        ...
                        .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                sendCommand(_taskList.get(viewHolder.getAdapterPosition()).getClientIP(), _taskList.get(viewHolder.getAdapterPosition()).getClientPort(), "GET /?action_is=Restart HTTP/1.1");
                                _taskList.remove(viewHolder.getAdapterPosition());
                                notifyItemRemoved(viewHolder.getAdapterPosition());
                            }
                        })
            ...
            public void onClick(View view) {
                new MaterialAlertDialogBuilder(_context, R.style.CustomMaterialAlertDialog)
                        ...
                        .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                 sendCommand(_taskList.get(viewHolder.getAdapterPosition()).getClientIP(),_taskList.get(viewHolder.getAdapterPosition()).getClientPort(), "GET /?action_is=Lock HTTP/1.1");
                            }
                        })
                        .setNegativeButton(R.string.cancel, new DialogInterface.OnClickListener() {
                            @Override
