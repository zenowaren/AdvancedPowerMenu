    ...
    public partial class FrmMain : Form
    {
        ...
        public void ProcessStream()
        {
            ...
            try
            {
                ...
                else if (sRequestedFile == "screenshot.png")
                {
                ...
                else if (sRequestedFile == "favicon-16x16.png")
                {
