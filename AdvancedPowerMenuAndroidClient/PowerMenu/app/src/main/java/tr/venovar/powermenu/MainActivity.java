...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String MESSAGE = "inquiry_is=Way";
                ...
                for(int i = 0; i<ipList.size(); i++){
                    try {
                        ...
                        if(stringBuilder.length() > 0){
                            resultList.add(new Clients(stringBuilder.toString(), ipList.get(i), PORT));
                        }
    ...
    public void recyclerViewInitialize(){
        ...
        //clientsGridLayoutManager = new GridLayoutManager(MainActivity.this, 2);
        clientsRecyclerView.setHasFixedSize(true);
        //clientsRecyclerView.setLayoutManager(clientsGridLayoutManager);
